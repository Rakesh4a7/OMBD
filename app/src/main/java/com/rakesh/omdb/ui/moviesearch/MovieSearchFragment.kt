package com.rakesh.omdb.ui.moviesearch
...
import com.rakesh.omdb.R
import com.rakesh.omdb.ui.base.BaseFragment
import com.rakesh.omdb.ui.clickable_adapter.ClickableViewHolder
import com.rakesh.omdb.ui.clickable_adapter.RecyclerViewClickListener
import com.rakesh.omdb.utils.PagingScrollListener
import com.rakesh.omdb.utils.Utils
import com.rakesh.omdb.utils.expandSearchView
...
class MovieSearchFragment: BaseFragment(), RecyclerViewClickListener<Movie> {
    ...
    private fun showData(movies: List<Movie>?) {
        ...
        Utils.doOnceOnGlobalLayoutOfView(view) { startPostponedEnterTransition() }
    }
